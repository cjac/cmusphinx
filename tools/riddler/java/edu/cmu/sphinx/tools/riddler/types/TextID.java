...
public class TextID {
    ...
    public RegionOfTextID[] getTextRegionIDs() {
        return textRegionIDs.toArray(new RegionOfTextID[]{});
    }

    public void setTextRegionIDs(RegionOfTextID[] textRegionIDs) {
        this.textRegionIDs = Arrays.asList(textRegionIDs);
    }
}
