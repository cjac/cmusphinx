...
public class CorpusBuilder extends BatchForcedAlignerRecognizer {
    ...
    */
    ...
    protected void handleResult(DataOutputStream out, CTLUtterance utt, Result result) throws IOException {
        ...
        //AudioDatabase adb = new AudioDatabase( stripExtension(utt.getFile()), 16,1,16000,100 );
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CorpusWriter cw = new CorpusXMLWriter( new FileOutputStream("dump.xml") );

            cw.write(me.corpus);

            CorpusReader cr = new CorpusXMLReader( new FileInputStream("dump.xml") );
