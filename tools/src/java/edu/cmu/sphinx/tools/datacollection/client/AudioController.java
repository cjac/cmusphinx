...
public class AudioController {
     ...
     */
    public AudioController(String serializedCorpus, ConfigurationManager cm) {
     ...
     */
    protected boolean isPreviousActive() {
     ...
     */
    protected boolean isNextActive() {
        switch (_currentState) {
            case BEFORE_RECORDING:
                return (_uttIterator.hasNext() && hasAudioData());
            case DURING_RECORDING:
                return false;
            case AFTER_RECORDING:
                return (_uttIterator.hasNext() && hasAudioData());
     ...
     */
    protected boolean isSubmitActive() {
        switch (_currentState) {
            case BEFORE_RECORDING:
                return ((!_uttIterator.hasNext()) && hasAudioData());
            case DURING_RECORDING:
     ...
     */
    protected boolean isPlayActive() {
        switch (_currentState) {
            case BEFORE_RECORDING:
                return hasAudioData();
            case DURING_RECORDING:
     ...
     */
    protected boolean isRecordActive() {
        switch (_currentState) {
            case BEFORE_RECORDING:
                return true;
            case DURING_RECORDING:
