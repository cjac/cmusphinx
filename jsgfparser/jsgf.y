...
jsgf_header: HEADER ';' { $$ = ckd_calloc(1, sizeof(*$$)); }
	| HEADER TOKEN ';' { $$ = ckd_calloc(1, sizeof(*$$)); $$->version = $2; }
	| HEADER TOKEN TOKEN ';' { $$ = ckd_calloc(1, sizeof(*$$));
				   $$->version = $2;
				   $$->charset = $3; }
	| HEADER TOKEN TOKEN TOKEN ';' { $$ = ckd_calloc(1, sizeof(*$$));
				       $$->version = $2;
				       $$->charset = $3;
				       $$->locale = $4; }
	;
