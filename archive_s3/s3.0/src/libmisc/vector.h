...
#ifndef _LIBMISC_VECTOR_H_
#define _LIBMISC_VECTOR_H_
 ...
 * gautbl->{n_mgau, veclen, distfloor}; the last to the equivalent of LOGPROB_ZERO.
 */
 ...
 *
 * $Log$
 * Revision 1.1  2000/04/24  09:07:30  lenzo
 * Import s3.0.
 * 
