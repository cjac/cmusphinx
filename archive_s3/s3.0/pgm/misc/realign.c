/*
 * realign.c -- Try to improve phone alignment for utternaces, given an initial alignment.
 * 
 * **********************************************
...
static void realign (float32 **mfc, int32 nfr)
{
}
...
static void process_psegfile (char *cepdir)
{
	...
	if ((nfr = s2mfc_read (cepfile, 0, (int32)0x70000000, &mfc)) <= 0)
