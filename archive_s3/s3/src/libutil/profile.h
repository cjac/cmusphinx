 ...
 */
typedef struct {
    float64 t_cpu;		/* CPU time accumulated since most recent reset operation */
    float64 t_elapsed;		/* Elapsed time accumulated since most recent reset */
    float64 t_tot_cpu;		/* Accumulated CPU time since timer creation */
    float64 t_tot_elapsed;	/* Accumulated elapsed time since timer creation */
