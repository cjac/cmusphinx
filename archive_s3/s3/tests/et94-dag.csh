...
#
# Sample script for running the shortest-path search on Wall Street Journal
# 1994 evaluation set lattices generated by s3decode.
# 
# Arguments for this script:
#     pgm:    Decoder program (i.e., ./{alpha,linux,...}/s3dag),
