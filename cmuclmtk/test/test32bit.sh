...
cat English/emma11.txt.filtered | $BIN/text2idngram -vocab English/emma11.vocab > ./English/emma11.txt.filtered.idngram.32bits
...
$BIN/idngram2lm -idngram ./English/emma11.idngram.32bits -vocab ./English/emma11.vocab -arpa English/emma11.filtered.arpa
...
$BIN/idngram2lm -idngram ./English/emma11.idngram.32bits -vocab ./English/emma11.vocab -binary English/emma11.filtered.bin
...
$BIN/idngram2lm -idngram ./English/emma11.idngram.32bits -vocab ./English/emma11.vocab -absolute -arpa English/emma11.filtered.arpa
...
$BIN/idngram2lm -idngram ./English/emma11.idngram.32bits -vocab ./English/emma11.vocab -linear -arpa English/emma11.filtered.arpa
...
$BIN/idngram2lm -idngram ./English/emma11.idngram.32bits -vocab ./English/emma11.vocab -witten_bell -arpa English/emma11.filtered.arpa
...
$BIN/binlm2arpa -binary ./English/emma11.bin.32bits -arpa convert.arpa
...
echo "perplexity -text ./English/pandp12.txt.filtered"  | $BIN/evallm -binary ./English/emma11.bin.32bits > ./tmp.perplexity
...
$BIN/ngram2mgram -n 3 -m 2 -binary < ./English/emma11.idngram.32bits > ./English/emma11.id2gram.filtered
...
$BIN/ngram2mgram -n 3 -m 1 -binary < ./English/emma11.idngram.32bits > ./English/emma11.id1gram.filtered
...
$BIN/mergeidngram -n 3 ./English/emma11.idngram.32bits ./English/pandp12.txt.idngram -ascii_output > ./English/combine.idngram.txt.filtered
...
$BIN/mergeidngram -n 3 ./English/emma11.idngram.32bits ./English/pandp12.txt.idngram > ./English/combine.idngram.filtered
...
$BIN/mergeidngram -n 3 ./English/emma11.idngram.txt ./English/pandp12.idngram.txt -ascii_input -ascii_output  |sed 's/\r//'> ./English/combine.idngram.txt.filtered
if ($DIFF ./English/combine.idngram.txt  ./English/combine.idngram.txt.filtered > /dev/null 2>&1); \
