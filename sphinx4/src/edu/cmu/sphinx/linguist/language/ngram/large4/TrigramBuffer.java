...
//	    }
        ...
        if (end!=getNumberNGrams()-1 &&  thirdWordID== getWordID(start) ) 
        	return getTrigramProbability(start);
        return null;
    }
