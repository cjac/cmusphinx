...
:: INSTANCE is the base name for all *generated* files
...
cd Resources
perl %LOGIOS_ROOT%\Tools\MakeLanguage\make_language.pl --logios %LOGIOS_ROOT% --resources %RESOURCES% --project %PROJECT% --instance %INSTANCE% --logfile %INSTANCE%.log
cd ..
